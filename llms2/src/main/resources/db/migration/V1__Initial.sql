...
create table reason (id bigint not null, text varchar(255) not null, category_id bigint not null, primary key (id ));
create table station (id integer not null, name varchar(255), primary key (id ));
create table ticket (id bigint not null, closed_timestamp timestamp, open_timestamp timestamp not null, status varchar(255) not null, department_id bigint not null, part_id bigint, reason_id bigint, station_id integer not null, primary key (id ));
...
insert into user_pages (user_username, pages) values ('admin', 'categories');
...
insert into user_pages (user_username, pages) values ('admin', 'stations');